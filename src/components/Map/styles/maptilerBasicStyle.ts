// MapTiler Basic v2 style
// https://www.maptiler.com/maps/basic/
// Fetched from https://api.maptiler.com/maps/basic-v2/style.json
...
const maptilerLayers = splitIconOpacityLayers([
  {
    id: 'Residential',
    type: 'fill',
  ...
  },
  {
    ...
    filter: ['!in', 'class', 'bridge', 'ferry', 'path', 'rail', 'transit'],
  },
  {
    id: 'Path minor',
    type: 'line',
  ...
  },
  {
    ...
    filter: ['all', ['==', 'class', 'railway'], ['has', 'subclass']],
  },
  {
    id: 'Road labels',
    type: 'symbol',
    ...
    filter: [
      'all',
      ['==', '$type', 'LineString'],
      ['!in', 'class', 'aerialway', 'ferry', 'service'],
    ],
  },
  {
    id: 'Other border',
...
export const maptilerBasicStyle = addHoverPaint({
  version: 8,
  id: 'basic-v2',
  name: 'MapTiler Basic',
