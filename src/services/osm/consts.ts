...
const PROD_SERVER = 'https://api.openstreetmap.org';
const OSM_WEBSITE = USE_PROD_API
  ? 'https://www.openstreetmap.org'
  : TEST_SERVER;

const API_SERVER = USE_PROD_API ? PROD_SERVER : TEST_SERVER;
...
const CLIMBING_TILES_HOST = localClimbingTiles
  ? '/'
